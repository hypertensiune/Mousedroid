...
wxMain::wxMain(SettingsManager &_settings, wxIcon &icon) : 
    wxFrame(nullptr, wxID_ANY, "Mousedroid", wxDefaultPosition, wxSize(APP_WIDTH, APP_HEIGHT), wxDEFAULT_FRAME_STYLE & ~wxRESIZE_BORDER & ~wxMAXIMIZE_BOX),
    settings(_settings)
{
    ...
    taskbar = new wxMTaskbar(this);
    taskbar->SetIcon(icon, "Mousedroid");
...
{    
    ...
    wxStaticBoxSizer *devsizer = new wxStaticBoxSizer(wxHORIZONTAL, tab_status, "Devices");
...
void wxMain::InitSettingsTab()
{
    ...
    wxSlider *ms = new wxSlider(tab_settings, SL_MOVE, 10, 1, 20, wxDefaultPosition, wxSize(150, wxDefaultSize.y), wxSL_TICKS);
    ...
    wxSlider *ss = new wxSlider(tab_settings, SL_SCROLL, 10, 1, 20, wxDefaultPosition, wxSize(150, wxDefaultSize.y), wxSL_TICKS);
